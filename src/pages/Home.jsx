    ...
    <main>
          ...
          <div className="mx-auto max-w-6xl px-4 py-12 text-white">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                {cfg.site?.motto && <p className="mt-2 text-primary-100 font-medium">{cfg.site.motto}</p>}
              </div>
            </div>
            <p className="mt-6 max-w-3xl text-primary-100">
              Bienvenidas y bienvenidos al sitio oficial del SITYPS. Somos una organización democrática
              al servicio de las y los trabajadores del sector salud, pública y privadamente.
            </p>

            <div className="mt-6 flex gap-3">
              <a href="#/preafiliacion"
      ...
      <section className="mx-auto max-w-6xl px-4 -mt-8 pb-10">
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {title: "Afiliación", img: "/img/afiliacion.jpg", text: "Acompañamiento y defensa de tus derechos."},
            {title: "Consultorios", img: "/img/consultorios.jpg", text: "Servicios médico-odontológicos por convenios."},
            {title: "Gestiones", img: "/img/gestiones.jpg", text: "Resultados reales, con transparencia."},
          ].map((c)=>(
